...
selected_adj_noun_path = foot_path + 'selected_adj_noun_0.95_1k.pth'  ############### note the file here.
...
# save_path="/home/notebook/code/personal/S9052995/syn_pro/OpenOOD/data/benchmark_imglist/imagenet/train_imagenet_idood11k_syn32_filtered_acc_pred.txt"
save_path="/home/notebook/code/personal/S9052995/syn_pro/OpenOOD/data/benchmark_imglist/imagenet/train_imagenet_idood1k_syn32to8_filtered_acc_pred.txt"
...
def select_by_clip_thres_RS(cls_ims, shot, clip_selector, cls_idx, thres=0.2):
    ...
    # return above_thres_paths  ## only return the samples satify rules. 
...
model, val_preprocess = clip.load('ViT-L/14', 'cuda', jit=False)
...
with open(save_path,'w') as f:
    for key in selected_dir.keys(): # '0'
        file_list = selected_dir[key]
        for file in file_list:
            line = file[len_pre:] +' '+str(key)+'\n'
            f.write(line)
    f.close()      
