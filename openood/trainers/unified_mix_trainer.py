##################### different from the oodmixup_trainer with introduce extra ood prompts / classes, 
# here we do not introduce any explicit ood class and treat the uniform ID distribution as ood class.
import numpy as np
import torch
...
class OodMixupTrainer:
    ...
    def train_epoch(self, epoch_idx):
        ...
        for train_step in tqdm(range(1,
            ...
            ood_label = soft_y.new_ones((soft_y.size(0), soft_y.size(1))) ## 128 * 1000
