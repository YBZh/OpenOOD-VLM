...
for gap in 0.2   ## number of used labels. 可能generated labels 在few negative label num 的情况下有效。
do
    for ood_number in 10000 #  2000 5000 10000 20000 50000 100000 200000 250000   ## activated-aware scores, 0 means activation-agnostics  ptis tisp  ###part_of_speech_tagging, neglabel_wordnet  fixedclip_negoodprompt_fullcorpus
    do
        python main.py \
        ...
        --merge_option merge \
        --output_dir ./aaneg_analyses_openood/ \
...
# # ##### 不同的 corpus dataset 以及不同  sized corpus dataset.
# tau=1.0
...
# memleng=200
# #  imagenet_temshift_spti imagenet_temshift_ptis imagenet_temshift_tisp  
# for seed in 0   ## number of used labels. 可能generated labels 在few negative label num 的情况下有效。
# do
#     for ood_number in 2000 5000 10000 20000 50000 100000 200000 250000   ## activated-aware scores, 0 means activation-agnostics  ptis tisp  ###part_of_speech_tagging, neglabel_wordnet  fixedclip_negoodprompt_fullcorpus
#     do
#         python main.py \
#         --config configs/datasets/imagenet/imagenet_train_fsood.yml \
#         configs/networks/fixed_clip.yml \
...
#         --ood_dataset.num_classes $((ood_number + 1000)) \
#         --evaluator.name ood_clip_tta \
#         --network.name fixedclip_negoodprompt_fullcorpus \
#         --network.backbone.corpus part_of_speech_tagging \
#         --network.backbone.ood_number ${ood_number} \
#         --network.backbone.text_prompt ${prompt} \
#         --network.backbone.text_center True \
#         --network.pretrained False \
...
#         --num_gpus 1 --num_workers 8 \
#         --merge_option merge \
#         --output_dir ./aaneg_analyses_corpussize/ \
#         --mark ${in_score}_alpha${alpha}_beta${beta}_gamma${gamma}_neg10k_ood_number_${ood_number}_random_${random_permute}_thres${thres}_gap${gap}_gsize${group_size}_memlen${memleng}
#     done
# done
