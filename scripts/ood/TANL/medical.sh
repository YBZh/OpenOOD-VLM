...
do
    for beta in 1000 #2 10 100 1000 10000 #  2000 5000 10000 20000 50000 100000 200000 250000   ## activated-aware scores, 0 means activation-agnostics  ptis tisp  ###part_of_speech_tagging, neglabel_wordnet  fixedclip_negoodprompt_fullcorpus
    do
        python main.py \
        --config configs/datasets/covid/covid_ood_idood.yml \
        ...
        --merge_option merge \
        --output_dir ./aaneg_analyses_medical/ \
