...
# gap=0.5
# alpha=0.01 ## threshold for value / max.
# for beta in 1000
# do
#     for in_score in sum
#     do
...
#         --merge_option merge \
#         --output_dir ./replace_non_activate_bothIDOOD_wholeneg_idlabel_noiseimage_negimagefeature/ \
#         --mark ${in_score}_alpha${alpha}_beta${beta}_neg10k_ood_number_${ood_number}_random_${random_permute}_thres${thres}_gap${gap}_gsize${group_size}_recalculatingscore_weighttext
#     done
# done

# # replace_non_activate_bothIDOOD_wholeneg_idlabel_noiseimage/imagenet_fixedclip_negoodprompt_test_ood_ood_clip_tta_actneg_sum_alpha0.01_beta1000_neg10k_ood_number_10000_random_False_thres0.5_gap0.5_gsize1000
# #  62.53±0.00   14.65±0.00   82.30±0.00   96.87±0.00   89.24±0.00   99.40±0.00   64.40±0.00   86.31±0.00   66.87±0.00  

# ## 再用updated score 来重新筛选neglabels, 并重新算neglabels 的结果是最好的。
# # replace_non_activate_bothIDOOD_wholeneg_idlabel_noiseimage/imagenet_fixedclip_negoodprompt_test_ood_ood_clip_tta_actneg_sum_alpha0.01_beta1000_neg10k_ood_number_10000_random_False_thres0.5_gap0.5_gsize1000_recalculatingscore
# #  57.06±0.00   10.91±0.00   84.95±0.00   97.61±0.00   90.63±0.00   99.55±0.00   67.72±0.00   88.39±0.00   66.87±0.00  
...
do
    ...
    do
        ...
        --merge_option merge \
        --output_dir ./remove_non_activate_with_OOD_min_ID/ \
        --mark ${in_score}_alpha${alpha}_beta${beta}_neg10k_ood_number_${ood_number}_random_${random_permute}_thres${thres}_gap${gap}_gsize${group_size}
    done
done
...
# # guiscore_text_mul guiscore_text_norm guiscore_text_add guiscore_text_cosonly guiscore_text_mul_merge 
# # --config configs/datasets/imagenet/imagenet_traditional_four_ood.yml \
# #         --config configs/datasets/imagenet/imagenet_train_fsood.yml \ 1000 100 5000 10000
# in_score=sum
# group_num=5
# group_size=1000
# ood_number=10000
...
#         --num_gpus 1 --num_workers 6 \
#         --merge_option merge \
#         --output_dir ./replace_non_activate_with_imagefeature/ \
#         --mark ${in_score}_alpha${alpha}_beta${beta}_neg10k_ood_number_${ood_number}_random_${random_permute}_thres${thres}_gap${gap}_gsize${group_size}
#     done
# done
