...
do
    ...
    do
        ...
        do
            ...
            --network.backbone.prompttype class_specific \
            ...
            --merge_option merge \
            --output_dir ./debug_oodval_dedup_scratch_nctx${N_CTX}_class_specific/ \
...
# for in_score in guiscore_img_cosonly_mod_merge
# do
...
# loss_components=classify
# # 
# for gs_loss_weight in 1-1-1-0.1
# do
